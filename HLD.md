...
1. **Shop/Store Owner** - Retail business operator
2. **Restaurant/Hotel Manager** - Food & beverage business
3. **Hospital/Clinic Administrator** - Healthcare services
4. **Educational Institution Head** - School/College
5. **E-commerce Merchant** - Online seller
6. **Service Provider/Delivery Partner** - Logistics & fulfillment
7. **Customer/End User** - Consumer of products/services
8. **Admin/System Manager** - Platform operator
